 ...
 */
public class ReciveMailBak {
    private final static Logger logger = LoggerFactory.getLogger(ReciveMailBak.class);
    ...
    public ReciveMailBak(MimeMessage mimeMessage) {
...
//        System.out.println("CONTENTTYPE: " + contenttype);
    ...
    public void saveAttachMent(String userName, String emailName, Part part) throws Exception {
    ...
    private void saveFile(String fileName, InputStream in) throws Exception {
        ...
        try {
            FileUtils.copyInputStreamToFile(in, storefile);
            System.out.println("storefile's path: " + storefile.toString() + "("  + ")");
