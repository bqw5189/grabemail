 ...
 */
public class ZLProcessCurriculumVitae implements IProcessCurriculumVitae {
    private static final String SOURCE_NAME = "zhaopin.com";
    private static final Logger logger = LoggerFactory.getLogger(ZLProcessCurriculumVitae.class);
